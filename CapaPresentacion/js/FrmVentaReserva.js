    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.d.Estado) {
                ...
                $("#txtIdclienteAte").val(data.d.Data.Cliente.IdCliente);
                ...
                var feres = data.d.Data.FechaReserva + " " + data.d.Data.Hora;
                $("#txtSubTotal").val(feres);

                ProductosParaVenta = data.d.Data.ListaDetalleReserva;
                mosProd_Precio();
